...
await expectVazir(page.locator('h2.wp-block-heading'), 'frontend heading');
...
await expectVazir(editor.locator('p').first(), 'Post Editor paragraph');
await expectVazir(editor.locator('h2').first(), 'Post Editor heading');
